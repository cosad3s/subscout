...
OUTPUT_CERO="$OUTPUT/$OUTPUT_TMP/cero"
OUTPUT_SUBHUNTR99="$OUTPUT/$OUTPUT_TMP/SubHuntr99"
OUTPUT_SUBFINDER="$OUTPUT/$OUTPUT_TMP/subfinder"
OUTPUT_THEHARVESTER="$OUTPUT/$OUTPUT_TMP/theHarvester"
OUTPUT_SHOSUBGO="$OUTPUT/$OUTPUT_TMP/shosubgo"
OUTPUT_FOFAX="$OUTPUT/$OUTPUT_TMP/fofax"
